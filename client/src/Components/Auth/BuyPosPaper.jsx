...
function BuyPosPaper(props) {
const[number,setNumber]= React.useState(null);
const[number2,setNumber2]= React.useState(null);
const[number3,setNumber3]= React.useState(null);
...
<Form.Group controlId="formBasicNumber">
 ...
 <Form.Group controlId="formBasicAddress">
 <Form.Label>Currently used platform</Form.Label>
  ...
  handleDescription={handleChange.bind(this,'content')}
   ...
   />
    ...
    <Form.Control type="number" placeholder="Enter average daily withdrawer amount" onChange= {handleChangeWithName3} value={number2} />
     ...
     <Form.Group controlId="formBasicNumber">
    <Form.Label>Enter Average daily deposit withdrawal amount</Form.Label>
    <Form.Control type="number" placeholder="Enter average daily deposit withdrawer amount" onChange= {handleChangeWithName4} value={number3} />
 </Form.Group>  
 <Location 
