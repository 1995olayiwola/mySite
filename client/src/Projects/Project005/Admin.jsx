...
const[number1,setNumber1]= React.useState(null);
 ...
 <Form.Group controlId="formBasicNumber">
    <Form.Label>Enter the current withdrawal charges</Form.Label>
    <Form.Control type="number" placeholder="Enter Amount in #"  name="number" onChange= {handleChangeWithName1}  value={number1}/>
 </Form.Group>
 <Form.Group controlId="formBasicNumber">
    <Form.Label>Enter the current transfer charges</Form.Label>
